...
enum AXID {
    ...
    static let activityPersonalRecordsCurrentBest = "activity-personal-records-current-best"
    static let activityPersonalRecordsPeriodPicker = "activity-personal-records-period-picker"
    static let workoutCompletionPRSection = "workout-completion-pr-section"
    ...
    static let settingsRowBedtimeReminder = "settings-row-bedtime-reminder"
    static let settingsRowBedtimeReminderLeadTime = "settings-row-bedtime-reminder-leadtime"
    static let settingsRowAppleWatchBedtimeReminder = "settings-row-applewatch-bedtime-reminder"
    static let settingsRowAppleWatchBedtimeReminderLeadTime = "settings-row-applewatch-bedtime-reminder-leadtime"
    static let settingsRowPostureReminder = "settings-row-posture-reminder"
